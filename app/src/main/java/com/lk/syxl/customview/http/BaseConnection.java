...
public abstract class BaseConnection {
    ...
    private void setURLConnectionCommonPara(){
        ...
        connection.setRequestProperty("User-Agent", "INGAGE (ANDROID)");
    }
...
//    }
    ...
    public String doRequest(com.lk.syxl.customview.http.HttpRequest request){
...
//        }
        //TODO cookie处理
        HttpURLConnection connection = getURLConnection();
//        connection.setRequestProperty(HTTP_REQ_COOKIE,"x-ienterprise-passport=\"Tsjz0CEXROLt1DhGgw5ARmjf6/WIPj2vKO1GUUK6FmQ=\";userId=\"645506\";x-ienterprise-tenant=254902");
        connection.setRequestProperty(HTTP_REQ_COOKIE,"x-ienterprise-passport=\"7EmpBubDsF7dfHmHRqhngQW78lRmINAst8AgrgSIkGk=\";userId=\"769525\";x-ienterprise-tenant=295049");
//        connection.addRequestProperty(HTTP_REQ_COOKIE,"JSESSIONID=3267983D96A29C82A8CC38194A57A5EF");
//        connection.setRequestProperty(HTTP_REQ_COOKIE,Utils.getCookie(connection.getURL().toString()));
    ...
    protected String doGetRequest(){
        ...
        try {
            ...
            result = sb.toString();
//            Utils.setCookies(connection.getURL().toString(),connection.getHeaderFields());
